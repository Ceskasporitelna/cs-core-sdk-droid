 ...
 * CsJsonBuilder} for them to take effect: <pre>   {@code
 *
 ...
 * multiset's type token. A {@code CsJson} is passed in to {@code create} for
 ...
 *       TypeAdapter<?> elementAdapter = csJson.getAdapter(TypeToken.get(elementType));
 ...
 * the foundation of how CsJson converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
   ...
   * support {@code type}.
   */
  <T> TypeAdapter<T> create(CsJson csJson, TypeToken<T> type);
}
