...
public final class ArrayTypeAdapter<E> extends TypeAdapter<Object> {
  public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
    ...
    public <T> TypeAdapter<T> create(CsJson csJson, TypeToken<T> typeToken) {
      ...
      Type componentType = $CsJson$Types.getArrayComponentType(type);
      TypeAdapter<?> componentTypeAdapter = csJson.getAdapter(TypeToken.get(componentType));
      return new ArrayTypeAdapter(
              csJson, componentTypeAdapter, $CsJson$Types.getRawType(componentType));
    }
  };
  ...
  public ArrayTypeAdapter(CsJson context, TypeAdapter<E> componentTypeAdapter, Class<E> componentType) {
