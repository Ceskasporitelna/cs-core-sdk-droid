...
import cz.csas.cscore.utils.csjson.internal.LinkedTreeMap;
...
public final class ObjectTypeAdapter extends TypeAdapter<Object> {
  public static final TypeAdapterFactory FACTORY = new TypeAdapterFactory() {
    ...
    public <T> TypeAdapter<T> create(CsJson csJson, TypeToken<T> type) {
      if (type.getRawType() == Object.class) {
        return (TypeAdapter<T>) new ObjectTypeAdapter(csJson);
      }
      return null;
    }
  };
  ...
  private ObjectTypeAdapter(CsJson csJson) {
    this.csJson = csJson;
  }
  ...
  @Override public void write(JsonWriter out, Object value) throws IOException {
    ...
    TypeAdapter<Object> typeAdapter = (TypeAdapter<Object>) csJson.getAdapter(value.getClass());
