...
import cz.csas.cscore.utils.csjson.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
  ...
  public static final TypeAdapter<Boolean> BOOLEAN = new TypeAdapter<Boolean>() {
    ...
    public Boolean read(JsonReader in) throws IOException {
      if (in.peek() == JsonToken.NULL) {
        ...
        // support strings for compatibility with CsJson 1.7
  ...
  public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
    ...
    public <T> TypeAdapter<T> create(CsJson csJson, TypeToken<T> typeToken) {
      ...
      final TypeAdapter<Date> dateTypeAdapter = csJson.getAdapter(Date.class);
  ...
  private static final class EnumTypeAdapter<T extends Enum<T>> extends TypeAdapter<T> {
    ...
    public EnumTypeAdapter(Class<T> classOfT) {
      try {
        for (T constant : classOfT.getEnumConstants()) {
          ...
          CsSerializedName annotation = classOfT.getField(name).getAnnotation(CsSerializedName.class);
          if (annotation != null) {
          ...
          if(constant instanceof HasValue){
            nameToConstant.put(((HasValue) constant).getValue(), constant);
            constantToName.put(constant, ((HasValue) constant).getValue());
          }else {
    ...
    public T read(JsonReader in) throws IOException {
      ...
      /**
       * Mapping with fallback to OTHER enum
       */
      String value = in.nextString();
      T constant = nameToConstant.get(value);
      if (constant == null) {
        constant = nameToConstant.get(null);
      }
      return constant;
    }

    public void write(JsonWriter out, T value) throws IOException {
      /*if(value instanceof HasValue && constantToName.get(value) == null) {
        constantToName.put(value, ((HasValue) value).getValue());
        nameToConstant.put(((HasValue) value).getValue(),value);
      }*/
