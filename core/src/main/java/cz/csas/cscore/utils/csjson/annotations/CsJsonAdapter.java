...
/**
 * An annotation that indicates the CsJson {@link cz.csas.cscore.utils.csjson.TypeAdapter} to use with a class
 * or field.
 *
 ...
 * field's type, and in the {@link CsJsonBuilder}. Field
 * annotations take precedence over {@code CsJsonBuilder}-registered type
 * adapters, which in turn take precedence over annotated types.
 *
 * <p>The class referenced by this annotation must be either a {@link
 * cz.csas.cscore.utils.csjson.TypeAdapter} or a {@link cz.csas.cscore.utils.csjson.TypeAdapterFactory}. Using the factory interface
 * makes it possible to delegate to the enclosing {@code CsJson} instance.
 *
 * @since 2.3
 *
...
public @interface CsJsonAdapter {

  /** Either a {@link cz.csas.cscore.utils.csjson.TypeAdapter} or {@link cz.csas.cscore.utils.csjson.TypeAdapterFactory}. */
  Class<?> value();
