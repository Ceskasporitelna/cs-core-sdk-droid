...
import cz.csas.cscore.client.rest.mime.FormUrlEncodedTypedOutput;
import cz.csas.cscore.client.rest.mime.MimeUtil;
import cz.csas.cscore.client.rest.mime.MultipartTypedOutput;
import cz.csas.cscore.client.rest.mime.TypedByteArray;
import cz.csas.cscore.client.rest.mime.TypedOutput;
import cz.csas.cscore.client.rest.mime.TypedString;
...
final class RequestBuilder implements RequestInterceptor.RequestFacade {
  ...
  RequestBuilder(String apiUrl, RestMethodInfo methodInfo, Converter converter, RequestSigner requestSigner) {
    this.apiUrl = apiUrl;
  ...
  public void signRequest() {
    ...
    try {
      if (body != null) {
        ...
        requestData = new String(bodyBytes, bodyCharset);
      }
    } catch (IOException e) {
      e.printStackTrace();
    }
    requestSigner.signRequest(apiUrl+relativeUrl, requestData, headers);
  }
  ...
  void setArguments(Object[] args) {
    ...
    for (int i = 0; i < count; i++) {
      ...
      if (annotationType == CsPath.class) {
        CsPath path = (CsPath) annotation;
      ...
      } else if (annotationType == CsEncodedPath.class) {
        String name = ((CsEncodedPath) annotation).value();
        if (value == null) {
          throw new IllegalArgumentException(
              "Path parameter \"" + name + "\" value must not be null.");
        }
        addPathParam(name, value.toString(), false);
      } else if (annotationType == CsQuery.class) {
        if (value != null) { // Skip null values.
          CsQuery query = (CsQuery) annotation;
          addQueryParam(query.value(), value, query.encodeName(), query.encodeValue());
        }
      } else if (annotationType == CsEncodedQuery.class) {
        if (value != null) { // Skip null values.
          CsEncodedQuery query = (CsEncodedQuery) annotation;
          addQueryParam(query.value(), value, false, false);
        }
      } else if (annotationType == CsQueryMap.class) {
        if (value != null) { // Skip null values.
          CsQueryMap queryMap = (CsQueryMap) annotation;
          addQueryParamMap(i, (Map<?, ?>) value, queryMap.encodeNames(), queryMap.encodeValues());
        }
      } else if (annotationType == CsEncodedQueryMap.class) {
        if (value != null) { // Skip null values.
          addQueryParamMap(i, (Map<?, ?>) value, false, false);
        }
      } else if (annotationType == CsHeader.class) {
        if (value != null) { // Skip null values.
          String name = ((CsHeader) annotation).value();
          if (value instanceof Iterable) {
            for (Object iterableValue : (Iterable<?>) value) {
              if (iterableValue != null) { // Skip null values.
      ...
      } else if (annotationType == CsField.class) {
        if (value != null) { // Skip null values.
          CsField field = (CsField) annotation;
      ...
      } else if (annotationType == CsFieldMap.class) {
        if (value != null) { // Skip null values.
          CsFieldMap fieldMap = (CsFieldMap) annotation;
      ...
      } else if (annotationType == CsPart.class) {
        if (value != null) { // Skip null values.
          String name = ((CsPart) annotation).value();
          String transferEncoding = ((CsPart) annotation).encoding();
      ...
      } else if (annotationType == CsPartMap.class) {
        if (value != null) { // Skip null values.
          String transferEncoding = ((CsPartMap) annotation).encoding();
          for (Map.Entry<?, ?> entry : ((Map<?, ?>) value).entrySet()) {
            Object entryKey = entry.getKey();
            if (entryKey == null) {
              throw new IllegalArgumentException(
      ...
      } else if (annotationType == CsBody.class) {
        if (value == null) {
