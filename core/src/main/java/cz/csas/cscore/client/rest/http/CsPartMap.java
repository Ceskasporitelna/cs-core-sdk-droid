 ...
 * <ul>
 * <li>If the type implements {@link cz.csas.cscore.client.rest.mime.TypedOutput TypedOutput} the headers and
 ...
 * cz.csas.cscore.client.rest.converter.Converter#toBody(Object)}.</li>
 * </ul>
 * <p>
 * <pre>
 * &#64;Multipart
...
@Target(PARAMETER)
@Retention(RUNTIME)
public @interface CsPartMap {
  /** The {@code Content-Transfer-Encoding} of this part. */
  String encoding() default MultipartTypedOutput.DEFAULT_TRANSFER_ENCODING;
}
