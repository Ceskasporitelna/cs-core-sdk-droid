 ...
 * {@link CsQueryMap @QueryMap} for URL-encoding equivalent.
 *
 * @see CsQuery
 * @see CsQueryMap
 * @deprecated Use {@link CsQueryMap} with {@link CsQueryMap#encodeValues() encodeValues = false}.
 */
@Documented
@Deprecated
@Target(PARAMETER)
@Retention(RUNTIME)
public @interface CsEncodedQueryMap {
}
