 ...
 * @since 04 /05/16.
 */
public class CreateSignableImmutableOTPInvalidTest extends WebApiClientTest {

    private final String X_JUDGE_CASE_POSTS_CREATE_SIGNABLE_INVALID = "webapi.posts.create.signable.immutable.OTP.invalid";
     ...
     */
    @Test
    public void testCreateSignableImmutableOTPInvalid() {
        ...
        assertEquals("2786560923", mSigningObject.getSignId());
        ...
        assertEquals("2786560923", mFilledSigningObject.getSignId());
        ...
        mTacSigningProcess.finishSigning("12345", new CallbackWebApi<SigningObject>() {
            @Override
