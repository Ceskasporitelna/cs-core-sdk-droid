 ...
 * @since 27/12/15.
 */
public class ListTest extends WebApiClientTest {

    private final String X_JUDGE_CASE_POSTS_LIST = "webapi.posts.list";
    ...
    public void setUp() {
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_CASE_POSTS_LIST, mXJudgeSessionHeader);
