 ...
 * @since 04 /05/16.
 */
public class CreateSignableManageableTest extends WebApiClientTest {

    private final String X_JUDGE_CASE_CONTACTS_CREATE_SIGNABLE = "webapi.contacts.create.signable.manageable";
     ...
     */
    @Test
    public void testCreateSignableManageable() {
        ...
        assertEquals(SigningState.DONE, mContact.signing().getSigningState());
