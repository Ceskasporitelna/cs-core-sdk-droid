 ...
 * @since 06 /12/15.
 */
public class LockerUnlockMigrationPasswordUnregister extends LockerTest {

    private final String X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_PASSWORD_UNREGISTER = "core.locker.unlockMigration.password.unregister";
    ...
    @Override
    public void setUp() {
        mXJudgeSessionHeader = X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_PASSWORD_UNREGISTER;
        super.setUp();
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_PASSWORD_UNREGISTER, mXJudgeSessionHeader);
    }
     ...
     */
    @Test
    public void testUnlockMigrationPasswordUnregister() {
        ...
        assertEquals(mError.getResponse().getStatus(), 401);
    }
}
