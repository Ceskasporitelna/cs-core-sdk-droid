 ...
 * @since 06 /12/15.
 */
public class LockerUnlockMigrationPasswordServerUnavailable extends LockerTest {

    private final String X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_PASSWORD_SERVER_UNAVAILABLE = "core.locker.unlockMigration.password.serverUnavailable";
    ...
    @Override
    public void setUp() {
        mXJudgeSessionHeader = X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_PASSWORD_SERVER_UNAVAILABLE;
        super.setUp();
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_PASSWORD_SERVER_UNAVAILABLE, mXJudgeSessionHeader);
    }
     ...
     */
    @Test
    public void testUnlockMigrationPasswordServerUnavailable() {
