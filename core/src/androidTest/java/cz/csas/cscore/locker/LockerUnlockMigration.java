...
public class LockerUnlockMigration extends LockerTest {
    ...
    private final String X_JUDGE_SESSION_HEADER_UNLOCK_WITHOUT_REGISTRATION = "core.locker.unlockMigration";
    ...
    @Override
    public void setUp() {
        mXJudgeSessionHeader = X_JUDGE_SESSION_HEADER_UNLOCK_WITHOUT_REGISTRATION;
        super.setUp();
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_SESSION_HEADER_UNLOCK_WITHOUT_REGISTRATION, mXJudgeSessionHeader);
    }
    ...
    public void testUnlockMigration() {
        ...
        mLocker.unlockAfterMigration(Constants.PASSWORD_TEST,
