 ...
 * @since 06 /12/15.
 */
public class LockerUnlockServerErrorTest extends LockerTest {
    private final String X_JUDGE_CASE_HEADER_UNLOCK_SERVER_ERROR = "core.locker.unlock.serverError";
    private final String X_JUDGE_SESSION_HEADER_UNLOCK_SERVER_ERROR = "core.locker.unlock.serverError.session";
    ...
    @Override
    public void setUp() {
        mXJudgeSessionHeader = X_JUDGE_SESSION_HEADER_UNLOCK_SERVER_ERROR;
        super.setUp();
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_CASE_HEADER_UNLOCK_SERVER_ERROR, mXJudgeSessionHeader);
    }
