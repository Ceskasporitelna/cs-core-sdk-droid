 ...
 * @since 06 /12/15.
 */
public class LockerUnlockMigrationUnregister extends LockerTest {

    private final String X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_UNREGISTER = "core.locker.unlockMigration.unregister";
    ...
    @Override
    public void setUp() {
        mXJudgeSessionHeader = X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_UNREGISTER;
        super.setUp();
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_UNREGISTER, mXJudgeSessionHeader);
    }
     ...
     */
    @Test
    public void testUnlockMigrationUnregister() {
