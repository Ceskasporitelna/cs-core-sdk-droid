 ...
 * @since 06 /12/15.
 */
public class LockerUnlockMigrationServerError extends LockerTest {

    private final String X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_SERVER_ERROR = "core.locker.unlockMigration.serverError";
    ...
    @Override
    public void setUp() {
        mXJudgeSessionHeader = X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_SERVER_ERROR;
        super.setUp();
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_SERVER_ERROR, mXJudgeSessionHeader);
    }
     ...
     */
    @Test
    public void testUnlockMigrationServerError() {
