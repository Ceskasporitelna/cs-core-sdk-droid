 ...
 * @since 06 /12/15.
 */
public class LockerUnlockMigrationBadPassword extends LockerTest {

    private final String X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_BAD_PASSWORD = "core.locker.unlockMigration.badPassword";
    private CountDownLatch mUnlockSignal;
    private RegistrationOrUnlockResponse mUnlockResponse;
    private State mState;
    private CsLockerError mError;

    @Override
    public void setUp() {
        mXJudgeSessionHeader = X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_BAD_PASSWORD;
        super.setUp();
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_SESSION_HEADER_UNLOCK_MIGRATION_BAD_PASSWORD, mXJudgeSessionHeader);
    }
    ...
    public void testUnlockMigrationBadPassword() {
        ...
        assertEquals(mError.getKind(), CsLockerError.Kind.MIGRATION_UNLOCK_FAILED);
    }
}
