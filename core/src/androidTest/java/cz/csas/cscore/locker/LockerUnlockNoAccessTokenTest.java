 ...
 * @since 10/03/16.
 */
public class LockerUnlockNoAccessTokenTest extends LockerTest {

    private final String X_JUDGE_CASE_HEADER_UNLOCK_NO_ACCESS_TOKEN = "core.locker.unlockBadAccesToken";
    private final String X_JUDGE_SESSION_HEADER_UNLOCK_NO_ACCESS_TOKEN = "core.locker.unlockBadAccesToken.session";
    ...
    @Override
    public void setUp() {
        mXJudgeSessionHeader = X_JUDGE_SESSION_HEADER_UNLOCK_NO_ACCESS_TOKEN;
        super.setUp();
        ...
        JudgeUtils.setJudge(mJudgeClient, X_JUDGE_CASE_HEADER_UNLOCK_NO_ACCESS_TOKEN, mXJudgeSessionHeader);
    }
     ...
     */
    @Test
    public void testLockerUnlockNoAccessToken() {
